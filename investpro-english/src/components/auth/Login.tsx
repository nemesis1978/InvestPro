        ...
        <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                >
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path fillRule="evenodd" d="M10 0C4.477 0 0 4.477 0 10c0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10 0-5.523-4.477-10-10-10zm6.636 13.636c-.128.18-.293.324-.488.43-.194.106-.404.16-.618.16h-10.91c-.214 0-.424-.054-.618-.16a1.45 1.45 0 01-.488-.43A9.091 9.091 0 012.91 10a9.091 9.091 0 011.604-3.636c.128-.18.293-.324.488-.43.194-.106.404-.16.618-.16h10.91c.214 0 .424.054.618.16.195.106.36.25.488.43A9.091 9.091 0 0117.09 10a9.091 9.091 0 01-1.604 3.636z" clipRule="evenodd" />
                  </svg>
                </a>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {t('haveAccount')}
              <Link to="/register" className="ml-1 font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
                {t('register')}
              </Link>
            </p>
          </div>
